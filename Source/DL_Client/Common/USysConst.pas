...
const
  ...
  cFI_FrameTransferDetailQuery = $0058;                 //短倒明细
...
begin
  ...
  AddMenuModuleItem('MAIN_L10', cFI_FrameTransferDetailQuery);
  ...
  AddMenuModuleItem('MAIN_M08', cFI_FormWaiXie, mtForm);
  AddMenuModuleItem('MAIN_M09', cFI_FrameWaiXie);
